<table style="font-size: 11pt; font-family: Arial;">
    <tr style="">
        <td colspan="6" style="font-weight: bold; text-align: center;height: 50px; font-size: 15pt;">PLANILHA DE ASSENTO NO ÔNIBUS</td>
    </tr>
    <tr >
        <td colspan="6" style="background-color: #44546a; color: #ffffff; text-align: center;font-size: 9pt;">Este formulário deve ser preenchido e enviado ao coordenador do circuito</td>
    </tr>
    <tr style="">
    ...
    <tr style="">
        <td colspan="6" style="border: solid 3px black;background-color: #4472c4; color: #ffffff; text-align: center;font-size: 12pt; font-weight: bold; height: 30px;">RELAÇÃO DE PASSAGEIROS</td>
    </tr>
    ...
    @for ($i = 0; $i < 23; $i++)
        <tr>
            ...
            <td style="width: 23%;text-align: center;">{{ data_get($passengers, ($i+24).'.passenger.name', '') }}</td>
            <td style="width: 23%;text-align: center;">{{ data_get($passengers, ($i+24).'.passenger.name', '') }}</td>
        </tr>
    @endfor
