...
watch(
    ...
    debounce(function (
            [valueSearch, valueFriday, valueSaturday, valueSunday, valueOrderDir, valueOrderField],
            [oldValSearch]
        ) {
                ...
                <div class="flex items-center gap-x-3">
                    <div class="relative flex gap-x-3">
                        <div class="flex h-6 items-center">
                            <Checkbox id="sexta" v-model="friday" name="sexta"/>
                        </div>
                    ...
                    <div class="relative flex gap-x-3">
                        <div class="flex h-6 items-center">
                            <Checkbox id="sabado" v-model="saturday" name="sabado"/>
                        </div>
                        <div class="text-sm leading-6">
                            <label
                                class="text-sm font-medium text-gray-700 dark:text-gray-300"
                    ...
                    <div class="relative flex gap-x-3">
                        <div class="flex h-6 items-center">
                            <Checkbox id="domingo" v-model="sunday" name="domingo"/>
                        </div>
                        <div class="text-sm leading-6">
                            <label
                                class="text-sm font-medium text-gray-700 dark:text-gray-300"
        ...
        <div class="-mx-4 overflow-x-auto px-4 py-4 sm:-mx-8 sm:px-8">
            ...
            >
                <table class="min-w-full table-fixed bg-white dark:bg-gray-800">
                    <thead>
                    <tr
                        class="border-b text-gray-800 font-weight-bold dark:border-gray-900 dark:text-gray-100"
                    >
                        <th
                    ...
                    <tr
                        ...
                        v-if="list.length > 0"
                        :key="item.id"
                        class="border-b text-gray-800 font-weight-bold hover:bg-gray-100 dark:border-gray-900 dark:text-gray-100 dark:hover:bg-gray-700"
                    >
                        ...
                        <td class="whitespace-nowrap px-5 py-5 text-center text-sm">
                            <span
                                :class="item.friday ? 'text-green-500' : 'text-red-500'"
                                title="Sexta"
                            >
                                <font-awesome-icon
                                    v-if="item.friday"
                        ...
                        <td class="whitespace-nowrap px-5 py-5 text-center text-sm">
                            <span
                                :class="item.saturday ? 'text-green-500' : 'text-red-500'"
                                title="Sábado"
                            >
                                <font-awesome-icon
                                    v-if="item.saturday"
                        ...
                        <td class="whitespace-nowrap px-5 py-5 text-center text-sm">
                            <span
                                :class="item.sunday ? 'text-green-500' : 'text-red-500'"
                                title="Domingo"
                            >
                                <font-awesome-icon
                                    v-if="item.sunday"
                        ...
                        <td class="whitespace-nowrap px-5 py-5 text-sm">
                                <span v-if="item.saldo < 0" class="rounded-md bg-red-500 p-2">
                                    Deve
                                </span>
                            <span v-else class="rounded-md bg-green-500 p-2">
                                    Pago
                                </span>
                        </td>
                        <td
                        ...
                        <td
                            class="whitespace-nowrap px-5 py-5 text-sm space-x-3"
                        >
                    ...
                    <tfoot>
                    <tr class="border-b text-gray-800 font-weight-bold hover:bg-gray-100 dark:border-gray-900 dark:text-gray-100 dark:hover:bg-gray-600 dark:bg-gray-700">
                        <td class="whitespace-nowrap px-5 py-5 text-center text-sm">Total</td>
                        <td></td>
                        ...
                        <td class="px-5 py-5 text-sm">
                            {{
                                ((parseInt(totais.friday) + parseInt(totais.saturday) + parseInt(totais.sunday)) * $inertia.page.props.valor_onibus).toLocaleString("pt-BR", {
                                    style: "currency",
                                    currency: "BRL"
                                })
                            }}
                        ...
                        <td></td>
                        <td
                            :class="(totais.amount - ((parseInt(totais.friday) + parseInt(totais.saturday) + parseInt(totais.sunday)) * $inertia.page.props.valor_onibus)) < 0 ? 'text-red-500' : ''"
                            class="px-5 py-5 text-sm"
                        >
                            {{
                                (totais.amount - ((parseInt(totais.friday) + parseInt(totais.saturday) + parseInt(totais.sunday)) * $inertia.page.props.valor_onibus)).toLocaleString("pt-BR", {
                                    style: "currency",
                                    currency: "BRL"
                                })
                            }}
