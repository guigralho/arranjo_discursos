                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink :active="route().current('speeches.index')" :href="route('speeches.index')">
                                    Discursos
                                </NavLink>
                            </div>
                        </div>
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            <button @click="toggleDark()">
                                <font-awesome-icon v-if="!isDark" class="text-gray-800" icon="fa-solid fa-moon"/>
                                <font-awesome-icon v-if="isDark" class="text-white" icon="fa-solid fa-sun"/>
                            </button>
